...
เริ่มจากคิดก่อนว่าเราจะเริ่มเกมไปจนจบได้ยังไง โดยจะเริ่มจากปริ้นกระดานมาแล้วรับอินพุต แต่ก่อนที่จะส่งไปเพื่อเอาไปทำต่อ จะมีการเช็คว่าเป็นคีย์ที่เราต้องการรึเปล่า ก่อนที่จะส่งไปเช็คอีกทีว่าช่องที่อยู่เป้นขอบกระดานที่เมื่อเดินไปในทิศที่รับ input มาจะตกกระดานมั้ย ถ้าตกกระดานก็จะเอาไปเก็บไว้ในตัวแปรเพื่อเอาไปเช็คตอนท้ายลูป </br>

ซึ่งถ้าผ่านมาทั้งหมถึงจะเริ่มเอาค่าที่รับมาไปเดินตัวplayer แล้วพออัพเดตplayer ก็จะเช็คว่าช่องที่เดินไปเจอ เจอหมวกหรือหลุมมั้ยเพื่อเอาไปเก็บไว้เช็คเงื่อนไข ตอนท้ายอีกที พออัพเดตตารางหมดแล้ว ก็จะเช็คเงื่อนไขตอนท้ายเกมลูปว่ามีเงื่อนไขที่ทำให้เกมจบรึเปล่า ถ้ายังไม่มีก็จะวนลูปไปเล่นในรอบถัดไป แต่ถ้ามีก็จะออกมาเพื่อแสดงผลลัพธ์สุดท้ายตามเงื่อนไขที่เก็บมา 
